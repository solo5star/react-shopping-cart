...
`,b=n.button`
  ...
  font-size: 24px;
  font-weight: 500;
`,l=r=>{const{onNavigate:t}=r;return e.jsx(j,{children:e.jsxs(w,{children:[e.jsxs(R,{onClick:()=>t("/"),children:[e.jsx("img",{alt:"홈",src:y,width:44}),e.jsx(N,{children:"SHOP"})]}),e.jsx(S,{children:e.jsxs(b,{onClick:()=>t("/cart"),children:["장바구니"," ",e.jsx(c,{state:h,children:a=>e.jsx(_,{show:a.length>0,children:a.length})})]})})]})})};try{l.displayName="Header",l.__docgenInfo={description:"",displayName:"Header",props:{onNavigate:{defaultValue:null,description:"",name:"onNavigate",required:!0,type:{name:"(to: string) => void"}}}}}catch{}const A={title:"Header",component:l},s={};var d,p,m;s.parameters={...s.parameters,docs:{...(d=s.parameters)==null?void 0:d.docs,source:{originalSource:"{}",...(m=(p=s.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};const I=["Default"];export{s as Default,I as __namedExportsOrder,A as default};
//# sourceMappingURL=Header.stories-5c3fd912.js.map
